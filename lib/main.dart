...
class _SkinsScreenState extends State<SkinsScreen> {
  ...
  Future<void> _buyOrSelect(String skin) async {
    ...
    if (unlocked) {
      ...
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('¡$skin activado! 🔥')));
    } else {
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Necesitas ${price - _cryoCoins} CryoCoins más')));
    }
  }
            ...
            return Card(
              ...
              child: ListTile(
                ...
                trailing: isSelected
                    ...
                    : Text(price == 0 ? 'GRATIS' : '$price 🪙', style: TextStyle(color: price == 0 ? Colors.greenAccent : Colors.amber, fontSize: 16, fontWeight: FontWeight.bold)),
