...
class GamePainter extends CustomPainter {
  ...
  void _drawNucleus(Canvas canvas) {
    ...
    for(int i=4;i>=1;i--)canvas.drawCircle(Offset(cx,cy),pulse+i*12,
        Paint()..color=tc.withOpacity(0.06*i)..style=PaintingStyle.stroke..strokeWidth=1.5);
    ...
    canvas.drawCircle(Offset(cx,cy),pulse,Paint()..shader=RadialGradient(
        colors:[Colors.white.withOpacity(0.95),tc.withOpacity(0.85),tc.withOpacity(0.2)],
    ...
    final blp=Paint()..color=tc.withOpacity(0.6)..style=PaintingStyle.stroke..strokeWidth=1.2;
    ...
    _arcBar(canvas,cx,cy,pulse+32,coreTemp,tc);
    _txt(canvas,'NÚCLEO CUÁNTICO',Offset(cx,cy+pulse+22),tc.withOpacity(0.8),9);
  }
